...
if(isset($_POST['submit'])){
    $to = "cardinstravelandtours@gmail.com"; // this is your Email address
    ...
    $subject2 = "Response from cardinstravelandtours.com";
				...
				<div class="row">
					...
					<div class="col-md-10 col-md-offset-1 animate-box">
						...
						<div class="row contact-info-wrap">
							<div class="col-md-3">
								<p><span><i class="icon-location"></i></span> 88, Boulevard Mwezi Gisabo <br> Bujumbura, Burundi</p>
							</div>
							<div class="col-md-3">
								<p><span><i class="icon-phone3"></i></span> <a href="tel://447440707022">+447440707022</a></p>
							</div>
							<div class="col-md-3">
								<p><span><i class="icon-paperplane"></i></span> <a href="mailto:cardinstravelandtours@gmail.com">cardinstravelandtours@gmail.com</a></p>
							</div>
							<div class="col-md-3">
								<p><span><i class="icon-globe"></i></span> <a href="http://inatagram.com/cardinstravelandtours">Find Me On Instagram</a></p>
							</div>
						</div>
					</div>
				</div>
