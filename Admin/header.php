...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../index.php" class="logo">
      ...
      <span class="logo-mini"><b>C</b>T&T</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Cardins</b>Travel&Tours</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="profile.php?user=<?php echo $_SESSION['user']; ?>" class="btn btn-default btn-flat">Profile</a>
                </div>
